...
import { buildPreviewCanvasBackground } from "./previewCanvas";
...
describe("print preview canvas", () => {
  ...
  it("creates a user-selected solid canvas without touching image data", () => {
    expect(buildPreviewCanvasBackground("solid", "#172a3a", "#111827", "#7c3aed")).toBe("#172a3a");
  });

  it("creates a user-selected gradient canvas without touching image data", () => {
